...
df <- read.table("poster/merged_smear_April23.csv", sep=";", header=T, stringsAsFactors = T, check.names = FALSE)
#df1 <- read.table("merged_smear_April23.csv", sep=";", header=T, stringsAsFactors = T, check.names = FALSE)
#df2 <- read.table("../../All_the_data/06_Results/01_extraction_optimization/Extractions_2022/Fragment_analysis_JAN23/RE-ANALYSIS_APRIL23/merged_smear_April23.csv", sep=";", header=T, stringsAsFactors = T, check.names = FALSE)
...
# level_order <- c('400', '405', '412','417','401','406','413','418','402','407','414','419','403','408','415','420','404','409','416','421','410','422','411','423','Lib_b_1','Lib_b_2','Lib_b_3','Lib_b_4') 
# 
