...
panel_text <- data.frame(Range = c("157-177 bp", "177-202 bp", "202-227 bp", "227-277 bp", "277-327 bp", "327-427 bp"),
    label = c("p = 0.0009", "p = 0.3105", "p = 0.0926", "p = 0.0064", "p = 0.0047", "p = 0.0133"))
...
# Add p-values for each panel
panel_text <- data.frame(Range = c("157-177 bp", "177-202 bp", "202-227 bp", "227-277 bp", "277-327 bp", "327-427 bp"),
                         label = c("p = 0.8525", "p = 0.3009", "p = 0.1628", "p = 0.1189", "p = 0.0555", "p = 0.0264"))
...
################################################################################
################ Plotting Figure 4 for in-depth interpretation #################
