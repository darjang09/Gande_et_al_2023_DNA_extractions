...
p3 <- ggplot(df, aes(Method, Percent, color = Buffer)) +
  ...
  facet_grid( ~ Range) +
  theme_minimal() +
  scale_color_manual(values=c("coral3", "darkseagreen4")) +
  scale_y_continuous() + 
  labs(title ="Relative molarity across fragment size intervals", y = "Relative molarity [%]") +
  theme(legend.position="bottom",
        axis.ticks.y = element_line(color = "black"),
        axis.ticks.x = element_line(color = "black"),
        panel.grid.major = element_blank(), 
...
p4 <- ggplot(df, aes(Method, Absolute, color = Buffer)) +
  ...
  scale_color_manual(values=c("coral3", "darkseagreen4")) +
  scale_y_continuous() + 
  labs(title ="Molarity across fragment size intervals", y = "Molarity [nM]") +
  theme(legend.position="bottom",
        axis.ticks.y = element_line(color = "black"),
        axis.ticks.x = element_line(color = "black"),
        panel.grid.major = element_blank(), 
